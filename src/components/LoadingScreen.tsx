...
export default function LoadingScreen() {
  return (
    <div id="loading_screen_container" className="min-h-screen w-full bg-[#08090c] flex flex-col items-center justify-center p-6 relative overflow-hidden font-sans text-gray-200">
      ...
      >
        ...
        <div id="loading_brand_emblem" className="relative mb-6">
          ...
          <motion.div
            ...
            className="absolute -top-1 -right-1 w-5 h-5 rounded-full bg-[#101014] border border-[#27272A] flex items-center justify-center shadow-lg"
          >
        ...
        {/* Display Typography */}
        <h1 id="loading_title" className="text-xl font-bold tracking-tight text-white mb-2 font-sans flex items-center gap-1.5">
        ...
        <p id="loading_subtitle" className="text-xs text-gray-400 font-mono tracking-wider uppercase mb-8">
          Synchronizing Scholar Workspace
        </p>

        {/* Elegant Progress Indicator */}
        <div id="loading_progress_container" className="w-48 h-1 bg-[#141417] rounded-full overflow-hidden border border-[#27272A]/40 mb-3">
          <motion.div
            initial={{ left: '-100%' }}
            animate={{ left: '100%' }}
        ...
        <p id="loading_status_text" className="text-[10px] text-gray-500 font-mono animate-pulse">
